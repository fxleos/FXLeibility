...
MSOption.flex = 1;
MSOption.inflex = 1;
MSOption.inflex2flex = 0;
MSOption.nondispatch = [0.85,0.9,0.95,1.0,1.05,1.1,1.15,1.2,1.438,1.724,2.068,2.48];
p_sim = zeros(Ti,length(MSOption.nondispatch));
...
for i_renew = 1 : length(MSOption.nondispatch)
    G_nondispatch_i = G_nondispatch*MSOption.nondispatch(i_renew);

    G_residual = Consumption - G_nondispatch_i;
